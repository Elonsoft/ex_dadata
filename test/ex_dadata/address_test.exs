defmodule ExDadata.AddressTest do
  ...
  describe "clean_address/2" do
    defmodule MockCleanAddressHTTPAdapter do
    ...
    test "returns addresses on success" do
      client = Client.new(nil, nil, MockCleanAddressHTTPAdapter)
  ...
  describe "suggest_address/2" do
    ...
    test "returns suggestion on success" do
      client = Client.new(nil, nil, MockSuggestAddressHTTPAdapter)
  ...
  describe "geocode_address/2" do
    ...
    test "returns addresses with coordinates on success" do
      client = Client.new(nil, nil, MockGeocodeAddressHTTPAdapter)
  ...
  describe "geolocate_address/2" do
    ...
    test "returns suggestion on success" do
      client = Client.new(nil, nil, MockGeolocateAddressHTTPAdapter)
