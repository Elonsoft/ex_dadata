defmodule ExDadata.Address.GeolocateAddressTest do
  use ExUnit.Case

  alias ExDadata.Address.GeolocateAddress
  ...
  describe "new!/1" do
    test "converts raw parameters into a struct" do
      ...
      assert GeolocateAddress.new!(attrs) == %GeolocateAddress{
               suggestions: [
                 %GeolocateAddress.Suggestion{
                   value: "г Москва, ул Хабаровская",
                   unrestricted_value: "г Москва, ул Хабаровская",
                   data: %GeolocateAddress.Suggestion.Data{
                     postal_code: nil,
                     country: "Россия",
                     country_iso_code: "RU",
                     federal_district: nil,
